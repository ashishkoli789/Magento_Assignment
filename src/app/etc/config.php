...
return [
     ...
     * CONFIG__DEFAULT__CARRIERS__DHL__API_KEY for carriers/dhl/api_key
     * CONFIG__DEFAULT__CARRIERS__DHL__PASSWORD for carriers/dhl/password
     * CONFIG__DEFAULT__CARRIERS__DHL__API_SECRET for carriers/dhl/api_secret
     * CONFIG__DEFAULT__CARRIERS__DHL__ACCOUNT for carriers/dhl/account
     * CONFIG__DEFAULT__CARRIERS__DHL__GATEWAY_XML_URL for carriers/dhl/gateway_xml_url
     * CONFIG__DEFAULT__CARRIERS__DHL__GATEWAY_REST_URL for carriers/dhl/gateway_rest_url
     ...
     * CONFIG__DEFAULT__NEWRELICREPORTING__GENERAL__ENTITY_GUID for newrelicreporting/general/entity_guid
        ...
        'default' => [
            ...
            'payment' => [
                ...
                'payment_services' => [
                    ...
                    'send_line_items' => '1',
                    'sdk_url' => 'https://commerce-payments-sdk.adobe.io/v0/4/PaymentSDK.js',
                    'legacy_admin_enabled' => '1',
                    'sdk_fallback_url' => 'https://payments-sdk.live.commerce-payment-services.com/v0/4/PaymentSDK.js',
                ],
                'payment_methods' => [
                    'method' => 'sandbox',
                ...
                'payment_services_paypal_fastlane' => [
                    ...
                    'can_use_checkout' => '1',
                    'is_gateway' => '1',
                    'paymentInfoKeys' => 'cc_type,cc_last_4,cc_exp_month/cc_exp_year,paypal_order_id,paypal_fastlane_profile,liability_shift,authentication_state',
                    'display_on_checkout' => '1',
                    'can_review_payment' => '0',
                ],
                ...
                'payment_services_paypal_smart_buttons' => [
                    ...
                    'display_buttons_start_of_checkout' => '0',
                    'sort_order' => '10',
                ...
                'payment_services_paypal_apm' => [
                    ...
                    'model' => 'PaymentServicesPaypalApmFacade',
                    'merchant_gateway_key' => null,
                    'order_status' => 'pending_payment',
                    'currency' => 'EUR',
                    'can_authorize' => '1',
                    ...
                    'can_use_checkout' => '1',
                    'is_gateway' => '1',
                    'paymentInfoKeys' => 'payment_source,paypal_order_id,paypal_txn_id',
                ],
                'braintree' => [
                    'title' => 'Credit Card',
                    'environment' => 'sandbox',
                    ...
                    'useccv' => '1',
                    'send_line_items' => '1',
                    'cctypes' => 'AE,VI,MC,DI,JCB,DN,MI,UPD,ELO',
                    'sort_order' => null,
                    'allowspecific' => '0',
                    'specificcountry' => null,
                    ...
                    'can_deny_payment' => '1',
                    'cctypes_braintree_mapper' => '{"american-express":"AE","discover":"DI","jcb":"JCB","mastercard":"MC","master-card":"MC","visa":"VI","maestro":"MI","uk-maestro":"MI","diners-club":"DN","unionpay":"UPD","elo":"ELO"}',
                    'order_status' => 'processing',
                    'gateway_url' => 'https://braintreegateway.com',
                    'sandbox_gateway_url' => 'https://sandbox.braintreegateway.com',
                ...
                'braintree_local_payment' => [
                    ...
                    'allowed_methods' => 'bancontact,eps,ideal,mybank,p24,sepa,pay_upon_invoice,blik',
                    'sort_order' => null,
                    'can_authorize' => '1',
                    'can_cancel' => '1',
                    'can_capture' => '1',
            ...
            'graphql' => [
                'validation' => [
                    ...
                    'query_length_limit_enabled' => '1',
                    'query_length_limit_allowed' => '1048576',
                ],
                'session' => [
                    'disable' => '0',
                ],
...
{{depend vat_id}}VAT: {{var vat_id}}{{/depend}}|',
            ...
            'carriers' => [
                ...
                'usps' => [
                    'active' => '0',
                    'usps_type' => 'USPS_XML',
                    'gateway_rest_prod_url' => 'https://api.usps.com/',
                    'gateway_rest_dev_url' => 'https://apis-tem.usps.com/',
                ...
                'dhl' => [
                    ...
                    'free_method' => 'G',
                    'sandbox_xml_url' => 'https://xmlpitest-ea.dhl.com/XMLShippingServlet',
                    'sandbox_rest_url' => 'https://express.api.dhl.com/mydhlapi/test',
            ...
            'system' => [
                'cron' => [
                    ...
                    'commerce_data_export' => [
                        ...
                        'schedule_lifetime' => '60',
                        'history_cleanup_every' => '60',
            ...
            'newrelicreporting' => [
                'general' => [
                    'enable' => '0',
                    'api_mode' => 'v2_rest',
                    'nerd_graph_api_url' => 'https://api.newrelic.com/graphql',
                    'app_name' => null,
                    'separate_apps' => null,
                ],
                'cron' => [
